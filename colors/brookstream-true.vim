"--------------------------------------------------------------------
" Name Of File: brookstream-true.vim.
" Description: vim colorscheme, based on brookstream
" Maintainer: Mike Vincent
" Creator: Mike Vincent
" Credits: Inspiration from brookstream by Peter Bäckströmfrom which was inspired by darkdot scheme.
" Last Change: Friday, April 19, 2019.
...
" highlight crazy chars..
hi SpecialKey term=bold gui=bold,inverse ctermfg=yellow guifg=#ffff00
